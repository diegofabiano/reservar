...
describe('Tester función reservarHorario ()', function () {
    it('Cuando se reserva un horario de un restaurant, el horario correspondiente se elimina.', function () {
    ...
    it('Cuando se reserva un horario que el restaurant no tiene, el arreglo se mantiene igual.', function () {
    ...
    it('el arreglo se mantiene igual cuando no se le pasa ningún parametro', function () {
...
describe("test obtenerPuntuacion", () => {
...
describe('Testeo función calificar ()', function () {
    it('testeo que se sumen las calificaciones.', function () {
    ...
    it('testeo que las calificaciones NO numericas no se sumen', function () {
        let restoTest1 = new Restaurant(4, "El mas calificado", "Pasta", "San Telmo", ["11:00", "21:00"], "../img/pasta1.jpg", [10, 9, 8]);
        let calificacionesInicialesRestoTest1 = restoTest1.calificaciones;
        let cantidadCalificacionesRestoTest1 = restoTest1.calificaciones.length;
    ...
    it('Controlo que solo se sumen las calificaciones entre 1 y 9', function () {
        let restoTest1 = new Restaurant(4, "El mas calificado", "Pasta", "San Telmo", ["11:00", "21:00"], "../img/pasta1.jpg", [10, 9, 8]);
        let cantidadCalificacionesRestoTest1 = restoTest1.calificaciones.length;
...
describe('Testeo función buscarRestaurante (id)', function () {
    ...
    it('Pruebo que la búsqueda devuelva un mensaje negativo cuando busco un elemento fuera del arreglo de restaurants.', function () {
...
describe('Testeo función obtenerRestaurantes ()', function () {
    ...
    it('Pruebo error en ciudad ("Miami", inexistente).', function () {
        let restoFiltrado2 = listado.obtenerRestaurantes('Pasta', 'Miami', '12:00');
        expect(restoFiltrado2).to.eql([]);
    });

    it('Pruebo error en horario ("04:00", inexistente).', function () {
        let restoFiltrado3 = listado.obtenerRestaurantes('Sushi', 'Berlín', '04:00');
